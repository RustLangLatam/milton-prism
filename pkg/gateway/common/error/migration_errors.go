...
var migrationErrorMessages = map[string]string{
	...
	"MIG111": "The selected database is not yet supported for this target language. Go supports PostgreSQL, MariaDB/MySQL, or MongoDB; other languages support MongoDB only.",
