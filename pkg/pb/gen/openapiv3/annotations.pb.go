...
const file_openapiv3_annotations_proto_rawDesc = "" +
	"\n" +
	"\x1bopenapiv3/annotations.proto\x12\n" +
	"openapi.v3\x1a google/protobuf/descriptor.proto\x1a\x19openapiv3/OpenAPIv3.proto:O\n" +
	...
	"\bproperty\x12\x1d.google.protobuf.FieldOptions\x18\xf7\b \x01(\v2\x12.openapi.v3.SchemaR\bpropertyB\x98\x01\n" +
	"\x0ecom.openapi.v3B\x10AnnotationsProtoP\x01Z+milton_prism/pkg/pb/gen/openapiv3;openapiv3\xa2\x02\x03OXX\xaa\x02\n" +
	"Openapi.V3\xca\x02\n" +
...
func file_openapiv3_annotations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_openapiv3_annotations_proto_rawDesc), len(file_openapiv3_annotations_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 4,
			NumServices:   0,
